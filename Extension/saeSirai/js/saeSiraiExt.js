...
{
	//Elemento:
	//<span class="iceOutTxt" id="contenidoForm:itemList:0:j_id146">377362</span>
	
	var total=document.getElementById("contenidoForm:itemList").rows.length;
	var totalSiraiCeldas = document.getElementById("contenidoForm:itemList").getElementsByTagName("td");
	
	//*************************************************************************************
	//Se obtiene el elemento
	var text0=totalSiraiCeldas[0].innerHTML;
	//Se separa el elemento por coma y se genera un vector de 4 items
	var text0Vec = text0.split("\"");
	//se extrae el cuarto items que esta en la posicion 3 
	// el items de la posicion 3 es: contenidoForm:itemList:0:j_id146
	// se crea un vector de este items separado por " : "
	// este vector tiene 4 items
	var text0VecId = text0Vec[3].split(":"); 
	//se utiliza el item ultimo que es: j_id146 en la posicion 3
	var idnie = text0VecId[3];
	//*************************************************************************************
	
	var text1=totalSiraiCeldas[1].innerHTML;
	var text1Vec = text1.split("\"");
	var text1VecId = text1Vec[3].split(":"); 
	var idapellidos = text1VecId[3];
	
	var text2=totalSiraiCeldas[2].innerHTML;
	var text2Vec = text2.split("\"");
	var text2VecId = text2Vec[3].split(":"); 
	var idnombres = text2VecId[3];

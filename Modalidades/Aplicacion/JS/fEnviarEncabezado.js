...
function enviarEncabezado(nivelEducativo)
{
	...
	{
		var pab1=document.getElementById('peb1').value;
		var pab2=document.getElementById('peb2').value;
		var pab3=document.getElementById('peb3').value;
		var pab4=document.getElementById('peb4').value;
		var pab5=document.getElementById('peb5').value;
		var pab6=document.getElementById('peb6').value;
		var pab7=document.getElementById('peb7').value;
		var pab8=document.getElementById('peb8').value;
		var pab9=document.getElementById('peb9').value;
		var pab10=document.getElementById('peb10').value;
		var pab11=document.getElementById('peb11').value;
		
		
		localStorage.setItem("p1", pab1);
